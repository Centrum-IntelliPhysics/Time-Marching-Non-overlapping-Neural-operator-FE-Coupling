...
foldername = 'full_square_with_L_shape_all_dataset_N100_89_169_CG2_all_ts_together_test5'  
...
for i in trange(N):
    ...
    for ts in trange(ts_end1 + 100):
        ...
        if ts >= ts_end1+19 and ts <= ts_end1 + 99:
        ...
        if (ts == ts_end1 + 19 or ts == ts_end1 + 89) and i ==1:
