...
foldername = 'static_data_ground_truth_uv_001_RBF_N_5_CG2_test5'  
...
for i in trange(N):
    ...
    U1_list.append(u[index_inner_square].reshape(-1,1))
    V1_list.append(v[index_inner_square].reshape(-1,1))
...
U1_value = np.hstack(U1_list)
V1_value = np.hstack(V1_list)
...
np.savetxt('U1_value.txt', U1_value)
np.savetxt('V1_value.txt', V1_value)
