...
os.chdir(os.path.join(originalDir, './' + 'prepare_DeepONet_static_elastic_real' + '/'))
print(os.getcwd())
...
plot_relative_error(X1_FE, Y1_FE, np.abs(U1_NO -U1_FE), 'u_error_coupling_10_inner', rf'$|u_{{x, \mathrm{{FE}}}} - u_{{x, \mathrm{{FE-NO}},\Omega_{{II}}}}^{{{10}}}|$')
plot_relative_error(X1_FE, Y1_FE, np.abs(V1_NO -V1_FE), 'v_error_coupling_10_inner', rf'$|u_{{y, \mathrm{{FE}}}} - u_{{y, \mathrm{{FE-NO}},\Omega_{{II}}}}^{{{10}}}|$')
plot_relative_error(X1_FE, Y1_FE, np.abs(e_xx_1_NO - e_xx_1), 'e_xx_error_coupling_10_inner', rf'$|\epsilon_{{xx,\mathrm{{FE}}}} - \epsilon_{{xx,\mathrm{{FE-NO}},\Omega_{{II}}}}^{{{10}}}|$')
plot_relative_error(X1_FE, Y1_FE, np.abs(e_yy_1_NO - e_yy_1), 'e_yy_error_coupling_10_inner', rf'$|\epsilon_{{yy,\mathrm{{FE}}}} - \epsilon_{{yy,\mathrm{{FE-NO}},\Omega_{{II}}}}^{{{10}}}|$')
plot_relative_error(X1_FE, Y1_FE, np.abs(e_xy_1_NO - e_xy_1), 'e_xy_error_coupling_10_inner', rf'$|\epsilon_{{xy,\mathrm{{FE}}}} - \epsilon_{{xy,\mathrm{{FE-NO}},\Omega_{{II}}}}^{{{10}}}|$')
...
plot_relative_error(X_NO, Y_NO, u_error_10_outer, 'u_error_coupling_10_outer', rf'$|u_{{x, \mathrm{{FE}}}} - u_{{x, \mathrm{{FE-NO}},\Omega_{{I}}}}^{{{10}}}|$')
plot_relative_error(X_NO, Y_NO, v_error_10_outer, 'v_error_coupling_10_outer', rf'$|u_{{y, \mathrm{{FE}}}} - u_{{y, \mathrm{{FE-NO}},\Omega_{{I}}}}^{{{10}}}|$')
plot_relative_error(X_NO, Y_NO, e_xx_error_10_outer, 'e_xx_error_coupling_10_outer', rf'$|\epsilon_{{xx,\mathrm{{FE}}}} - \epsilon_{{xx,\mathrm{{FE-NO}},\Omega_{{I}}}}^{{{10}}}|$')
plot_relative_error(X_NO, Y_NO, e_yy_error_10_outer, 'e_yy_error_coupling_10_outer', rf'$|\epsilon_{{yy,\mathrm{{FE}}}} - \epsilon_{{yy,\mathrm{{FE-NO}},\Omega_{{I}}}}^{{{10}}}|$')
plot_relative_error(X_NO, Y_NO, e_xy_error_10_outer, 'e_xy_error_coupling_10_outer', rf'$|\epsilon_{{xy,\mathrm{{FE}}}} - \epsilon_{{xy,\mathrm{{FE-NO}},\Omega_{{I}}}}^{{{10}}}|$')
